...
--
-- Name: companies_clone; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.companies_clone (
    id bigint,
...
--
-- Name: index_companies_on_exchange_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_companies_on_exchange_id ON public.companies USING btree (exchange_id);


--
-- Name: index_companies_on_exchange_name_and_symbol; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_companies_on_exchange_name_and_symbol ON public.companies USING btree (exchange_name, symbol);
...
CREATE INDEX index_exchanges_on_name ON public.exchanges USING btree (name);
